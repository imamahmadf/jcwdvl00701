          ...
          >
            ...
            >
              <HStack>
                <Button
                  rounded="full"
                  onClick={() => setVisitor((current) => current - 1)}
                  disabled={visitor <= 1}
                >
                  -
                </Button>
          ...
          <Button
            ...
            onClick={() => {
              ...
              selectedLocations.forEach((locId) =>
                params2.append("propLocation", locId.value)
              );
              history.push({
                pathname: "/list/",
      ...
      <Flex justify="space-between" align="center" mt={2}>
        <Box color="gray.600" w="100%" cursor="pointer">
          ...
          <Flex align={"end"}>
            {isDiscount ? (
              <>
                <Text as={"s"} fontSize={"sm"} color={"gray"} mr={1}>
                  Rp.{property.defaultPrice},00
                </Text>
      ...
      <Box>
        ...
        <Container maxW="container.lg">
          ...
          {highlighted.map((highlight) => (
            <Thumbnail properties={highlight} />
          ))}
        </Container>
      </Box>
    </Layout>
